...
const Jobs = () => {
  return (
    <div className = "jobs-section">
      ...
      <Job className = "yellow" title = "Responsable d'Atelier" contractType = "CDD" country = "France" city = "Paris"/>
      ...
      <Job className = "blue" title = "Infirmier" contractType = "CDI" country = "France" city = "Paris"/>
    </div>
  );
};
